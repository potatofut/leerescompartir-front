 ...
 * Muestra la información legal y reglas de uso de la plataforma
 * Incluye secciones sobre aceptación, descripción del servicio, registro, uso aceptable,
 * responsabilidades, modificaciones y terminación del servicio
 */
export default function TermsPage() {
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      {/* Contenedor principal de los términos */}
      <div className="bg-white p-8 rounded-xl shadow-lg border border-orange-200">
        <div className="prose max-w-4xl mx-auto text-orange-900">
          ...
          {/* Sección 5: Responsabilidad por los libros */}
